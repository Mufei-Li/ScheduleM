// Ported from script.js standardizeLocation logic
...
export const standardizeLocation = (loc: string): LocationInfo => {
    ...
    // const buildingSuffixes = "楼|教|馆|室|厅|部|大楼|场|苑|中心|程|基地"; // Unused in original script logic actually used regex
    ...
    const pushCandidates = (re: RegExp, kind: string, baseScore: number) => {
        let m;
        re.lastIndex = 0;
