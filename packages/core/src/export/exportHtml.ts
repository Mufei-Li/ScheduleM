...
const renderEventItem = (ev: any, options: HTMLOptions): string => {
...
const renderMonth = (date: Date, events: CalendarEvent[], options: HTMLOptions): string => {
...
export const generateHTML = (events: CalendarEvent[], options: HTMLOptions): string => {
