...
const core_1 = require("@schedulem/core");
class LLMService {
    constructor() {
        this.config = {
...
6. **不要**包含 Markdown 格式（如 \`\`\`json）。仅返回纯 JSON 字符串。`
            ...
            const sanitizePeriodRange = (periodRange) => {
                ...
                return core_1.TimeUtils.sanitizePeriodRange(periodRange);
            };
            result.courses.forEach((course) => {
                ...
                if (course && typeof course === 'object') {
                    if (typeof course.className === 'string') {
                        ...
                        if (before !== after) {
                            if (debug)
                                console.debug('field_fix', { field: 'className', before, after });
                    ...
                    if (typeof course.room === 'string') {
                        ...
                        if (before !== after) {
                            if (debug)
                                console.debug('field_fix', { field: 'room', before, after });
                            course.room = after;
                        }
                    }
                    if (typeof course.building === 'string') {
                        ...
                        if (before !== after) {
                            if (debug)
                                console.debug('field_fix', { field: 'building', before, after });
                    ...
                    if (typeof course.location === 'string') {
                        ...
                        if (before !== after) {
                            if (debug)
                                console.debug('field_fix', { field: 'location', before, after });
                    ...
                    if (typeof course.name === 'string') {
                        ...
                        if (before !== after) {
                            if (debug)
                                console.debug('field_fix', { field: 'name', before, after });
                            course.name = after;
                        }
                    }
                    if (typeof course.teacher === 'string') {
                        ...
                        if (before !== after) {
                            if (debug)
                                console.debug('field_fix', { field: 'teacher', before, after });
                    ...
                    if (typeof course.periodRange === 'string') {
                        ...
                        if (before !== after) {
                            if (debug)
                                console.debug('field_fix', { field: 'periodRange', before, after });
    ...
    parseWeekString(str) {
        return core_1.TimeUtils.parseWeekString(str, { maxWeek: 50 });
    }
